					...
					<form action="/updateRH" method="POST">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Post</label> <input
								...
								value=${rh.getPost() } required="required">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">role</label> <input
								class="form-control" aria-describedby="emailHelp" name="role"
								value=${rh.getRole() } required="required">
						</div>
