<%@page import="com.upm.rh.entity.Bulletin"%>
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Informations personnelles</h1>

					</div>

				<%List<user> users = (List<user>) request.getAttribute("users"); 
				Bulletin bull= (Bulletin) request.getAttribute("bull");%>

					<!-- Content Row -->
					<form action="/updateBull">
						<div class="form-group">
							<label for="exampleInputEmail1">CIN</label> <select
								class="form-control" aria-describedby="emailHelp" id="monselect" name="idemp">
								
								
								<option value="<%=bull.getUser().getId() %>" ><%=bull.getUser().getId()%></option>
						...
						<div class="form-group">
							<label for="exampleInputEmail1">nbHeurs</label> <input
								class="form-control" aria-describedby="emailHelp" name="nbHeurs"
								value=<%=bull.getNbHeurs() %>>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">nbHeursBenus</label> <input
								class="form-control" aria-describedby="emailHelp"
								name="nbHeursBenus" value=<%=bull.getNbHeursBenus() %>>
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">prime</label> <input
								class="form-control" aria-describedby="emailHelp" name="prime"
								value=<%=bull.getPrime() %>>
						</div>
						<div class="form-group">
							 <input
								class="form-control" aria-describedby="emailHelp" name="idBulletin"
								value=<%=bull.getIdBulletin() %> type="hidden" >
						</div>
