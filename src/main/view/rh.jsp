			...
			<div id="content">
				...
				<div class="container-fluid">
							...
							<div class="card border-left-primary shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-primary text-uppercase mb-1">Salaries
												(Monthly)</div>
											<%
												long sumsal = (long) request.getAttribute("sumsal");
											%>
											<div class="h5 mb-0 font-weight-bold text-gray-800"><%=sumsal + " DH"%></div>
										</div>
										<div class="col-auto">
									...
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												...
												workers</div>
											<%
												long totaluser = (long) request.getAttribute("totaluser");
											%>
							...
							<div class="card border-left-info shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-info text-uppercase mb-1">working
												hours</div>
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<%
														long SumTauxTrav = (long) request.getAttribute("SumTauxTrav");
													%>
													<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><%=SumTauxTrav + "%"%></div>
												</div>
												<div class="col">
													<div class="progress progress-sm mr-2">
														<div class="progress-bar bg-info" role="progressbar"
															style="width: <%=SumTauxTrav + "%"%>" aria-valuenow="50"
							...
							<div class="card border-left-warning shadow h-100 py-2">
								<div class="card-body">
									<div class="row no-gutters align-items-center">
										<div class="col mr-2">
											<div
												class="text-xs font-weight-bold text-info text-uppercase mb-1">bonus
												hours</div>
											<div class="row no-gutters align-items-center">
												<div class="col-auto">
													<%
														long SumTauxBns = (long) request.getAttribute("SumTauxBns");
													%>
													<div class="h5 mb-0 mr-3 font-weight-bold text-gray-800"><%=SumTauxBns + " %"%></div>
												</div>
												<div class="col">
													<div class="progress progress-sm mr-2">
														<div class="progress-bar bg-warning" role="progressbar"
															style="width: <%=SumTauxBns + "%"%>" aria-valuenow="50"
															aria-valuemin="0" aria-valuemax="100"></div>
													</div>
												</div>
											</div>
					...
					<div class="row">
						...
						<div class="col-xl-8 col-lg-7">
							<div class="card shadow mb-4">
								...
								<div
									...
									<h6 class="m-0 font-weight-bold text-primary">Formations
										Chart</h6>
						...
						<!-- Pie Chart -->
						<div class="col-xl-4 col-lg-5" hidden="hidden">
							<div class="card shadow mb-4">
								<!-- Card Header - Dropdown -->
								<div
									class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
								...
								<div class="card-body">
									<div class="chart-pie pt-4 pb-2">
										<canvas id="doughnutChart" width="464" height="283"
											class="chartjs-render-monitor"
											style="display: block; height: 252px; width: 413px;"></canvas>
									</div>
							...
							<div class="card shadow mb-4">
								...
								<div class="card-body">
									...
									<div class="mt-4 text-center small">
										<span class="mr-2"> <i
											class="fas fa-circle text-primary"></i> Secteurs
										</span>
									</div>
								</div>
							</div>
					...
					<div class="card">
						...
						<div class="row">
							<div class="col-md-6">
								...
								<!-- Google Maps -->
								<div id="map-within-card-2" class="map-container rounded-left"
									style="height: 400px">
									<iframe
							...
							<div class="col-10 col-md-4 mx-auto align-self-center py-4">
								...
								<h6 class="font-weight-bold grey-text text-uppercase small">Head
									Office</h6>
								<h5 class="font-weight-normal mb-4">Marrakech ,MAROC</h5>
								<p class="text-muted font-weight-light">
									2651 Massira Street, Suit 124<br>Marrakech, WA, 98101
								</p>
								<p class="text-muted font-weight-light mb-0">
									Phone: +212 6 3904 1699<br>Email: hafid8live@hotmail.fr
								</p>
			...
			<footer class="sticky-footer bg-white">
				<div class="container my-auto">
					<div class="copyright text-center my-auto">
						<span>Copyright &copy; RH 2020</span>
					</div>
				</div>
			</footer>
			<!-- End of Footer -->
