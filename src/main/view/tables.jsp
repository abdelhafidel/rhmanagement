					...
					<form action="/updateAdmin" method="POST">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">role</label> <input
								...
								value=${admin.getRole() } required="required">
						</div>
