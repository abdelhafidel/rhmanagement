...
<body id="page-top">
	...
	<div id="wrapper">
		...
		<ul
			...
			<!-- Nav Item - Charts -->
			<li class="nav-item"><a class="nav-link" href="/formations"> <i
					class="fas fa-fw fa-chart-area"></i> <span>List des formation</span></a>
			</li>
		...
		<div id="content-wrapper" class="d-flex flex-column">
			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<!-- Content Row -->
					<form action="/AdminsaveModifyrh?id=${user.getId() }" method="POST">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">Mot de pass</label> <input
								class="form-control" aria-describedby="emailHelp" name="pwd"
