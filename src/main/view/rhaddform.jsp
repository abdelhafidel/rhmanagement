			...
			<div id="content">
				...
				<div class="container-fluid">
					...
					<div
						...
						<h1 class="h3 mb-0 text-gray-800">Ajouter formation</h1>

					</div>

					<!-- Content Row -->
					<form action="/rhsaveform">
						<div class="form-group">
							<label for="exampleInputEmail1">NOM</label> <input
								class="form-control" aria-describedby="emailHelp"
								name="formationLibelle" required="required">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">DUREE</label> <input
								class="form-control" aria-describedby="emailHelp" type="date" name="duree">
						</div>
						<div class="form-group">
							<label for="exampleInputEmail1">OBJECTIF</label> <input
								class="form-control" aria-describedby="emailHelp"
								name="objectif" required="required">
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							<label for="exampleInputEmail1">LIEN</label> <input
								class="form-control" aria-describedby="emailHelp" name="lien" required="required">
						</div>
